...
const mockFinanceUsers: FinanceUser[] = [
  {
    id: "FE1234",
    name: "Cintia Putri",
    phone: "08812345678",
...
export default function FinanceUsersPage() {
  const [users, setUsers] = useState<FinanceUser[]>(mockFinanceUsers)
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">User &gt; Finance</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>Manajemen Akun Finance</CardTitle>
            <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Tambah Akun Finance Baru</DialogTitle>
                </DialogHeader>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Edit Akun Finance</DialogTitle>
          </DialogHeader>
          {selectedUser && (
